...
namespace DistantLands.Cozy
{
    ...
    public class ChanceEffector
    {
        ...
        public enum LimitType { Temperature, Precipitation, YearPercentage, Time };
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            switch (property.FindPropertyRelative("limitType").intValue)
            {
                ...
                case (1):
                    ...
                    break;
                case (2): presets.Add(new AnimationCurve(new Keyframe(0, 0), new Keyframe(1, 0), new Keyframe(0.1f, 0), new Keyframe(0.2f, 1), new Keyframe(0.35f, 1), new Keyframe(0.45f, 0)));
                    ...
                    break;
                case (3): presets.Add(new AnimationCurve(new Keyframe(0, 1), new Keyframe(0.2f, 1), new Keyframe(0.25f, 0), new Keyframe(0.75f, 0), new Keyframe(0.8f, 1), new Keyframe(1, 1)));
